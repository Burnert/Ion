/*
    ...
    WGL loader generated by glad 0.1.34 on Tue Apr  6 19:46:30 2021.
    ...
    Commandline:
        --api="wgl=1.0" --generator="c" --spec="wgl" --extensions="WGL_ARB_create_context,WGL_ARB_create_context_profile,WGL_ARB_extensions_string,WGL_ARB_make_current_read,WGL_ARB_pixel_format,WGL_EXT_extensions_string,WGL_EXT_swap_control,WGL_EXT_swap_control_tear"
    Online:
        https://glad.dav1d.de/#language=c&specification=wgl&loader=on&api=wgl%3D1.0&extensions=WGL_ARB_create_context&extensions=WGL_ARB_create_context_profile&extensions=WGL_ARB_extensions_string&extensions=WGL_ARB_make_current_read&extensions=WGL_ARB_pixel_format&extensions=WGL_EXT_extensions_string&extensions=WGL_EXT_swap_control&extensions=WGL_EXT_swap_control_tear
*/
