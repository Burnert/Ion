...
{ 
	...
	#ifdef ION_ENGINE
		#define ION_LOG_ENGINE_TRACE(...)      Ion::LoggerOld::GetEngineLogger()->trace(__VA_ARGS__)
		#define ION_LOG_ENGINE_DEBUG(...)      Ion::LoggerOld::GetEngineLogger()->debug(__VA_ARGS__)
		#define ION_LOG_ENGINE_INFO(...)       Ion::LoggerOld::GetEngineLogger()->info(__VA_ARGS__)
		#define ION_LOG_ENGINE_WARN(...)       Ion::LoggerOld::GetEngineLogger()->warn(__VA_ARGS__)
		#define ION_LOG_ENGINE_ERROR(...)      Ion::LoggerOld::GetEngineLogger()->error(__VA_ARGS__)
		#define ION_LOG_ENGINE_CRITICAL(...)   Ion::LoggerOld::GetEngineLogger()->critical(__VA_ARGS__)
	...
	#define ION_LOG_TRACE(...)                 Ion::LoggerOld::GetClientLogger()->trace(__VA_ARGS__)
	#define ION_LOG_DEBUG(...)                 Ion::LoggerOld::GetClientLogger()->debug(__VA_ARGS__)
	#define ION_LOG_INFO(...)                  Ion::LoggerOld::GetClientLogger()->info(__VA_ARGS__)
	#define ION_LOG_WARN(...)                  Ion::LoggerOld::GetClientLogger()->warn(__VA_ARGS__)
	#define ION_LOG_ERROR(...)                 Ion::LoggerOld::GetClientLogger()->error(__VA_ARGS__)
	#define ION_LOG_CRITICAL(...)              Ion::LoggerOld::GetClientLogger()->critical(__VA_ARGS__)
