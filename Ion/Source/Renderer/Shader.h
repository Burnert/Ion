...
namespace Ion
{
	...
	public:
		...
		virtual void SetUniform2f(const std::string& name, const Vector2& value) const = 0;
		virtual void SetUniform3f(const std::string& name, const Vector3& value) const = 0;
		virtual void SetUniform4f(const std::string& name, const Vector4& value) const = 0;
		...
		virtual void SetUniformMatrix2f(const std::string& name, const Matrix2& value) const = 0;
		virtual void SetUniformMatrix2x3f(const std::string& name, const Matrix2x3& value) const = 0;
		virtual void SetUniformMatrix2x4f(const std::string& name, const Matrix2x4& value) const = 0;
		virtual void SetUniformMatrix3f(const std::string& name, const Matrix3& value) const = 0;
		virtual void SetUniformMatrix3x2f(const std::string& name, const Matrix3x2& value) const = 0;
		virtual void SetUniformMatrix3x4f(const std::string& name, const Matrix3x4& value) const = 0;
		virtual void SetUniformMatrix4f(const std::string& name, const Matrix4& value) const = 0;
		virtual void SetUniformMatrix4x2f(const std::string& name, const Matrix4x2& value) const = 0;
		virtual void SetUniformMatrix4x3f(const std::string& name, const Matrix4x3& value) const = 0;
