...
namespace Ion
{
	...
	public:
		...
		static constexpr D3D11_USAGE UsageToDX11Usage(ETextureUsage usage);
		static constexpr D3D11_TEXTURE_ADDRESS_MODE WrapModeToDX11AddressMode(ETextureWrapMode mode);
		static constexpr D3D11_MAP MapTypeToDX11Map(ETextureMapType mapType);
		static constexpr D3D11_FILTER SelectDX11Filter(ETextureFilteringMethod minFilter, ETextureFilteringMethod magFilter, ETextureFilteringMethod mipFilter);
	...
	inline constexpr D3D11_USAGE DX11Texture::UsageToDX11Usage(ETextureUsage usage)
	{
		switch (usage)
		{
	...
	inline constexpr D3D11_TEXTURE_ADDRESS_MODE DX11Texture::WrapModeToDX11AddressMode(ETextureWrapMode mode)
	{
		switch (mode)
		{
	...
	inline constexpr D3D11_MAP DX11Texture::MapTypeToDX11Map(ETextureMapType mapType)
	{
		switch (mapType)
		{
	...
	inline constexpr D3D11_FILTER DX11Texture::SelectDX11Filter(ETextureFilteringMethod minFilter, ETextureFilteringMethod magFilter, ETextureFilteringMethod mipFilter)
	{
		switch (minFilter)
		{
